# Journal: Mammalian Biology for the Special Issue - Individual Identification and Photographic Methods in Mammalian Ecological and Behavioral Research
# Manuscript title: Assessing male gelada chest patches: color measurement and physiological mechanisms
# Authors: Patricia M DeLacey, Rachel F Perlman, Sharmi Sen, India Schneider-Crease, Kenneth L. Chiou, 
# Alemayehu Lemma, Ferehiwot Ayele, James P. Higham, Amy Lu, Noah Snyder-Mackler, Jacinta C. Beehner, Thore J. Bergman
# Code by Patricia DeLacey 
...
# load data
load(file="/Users/patsydelacey/Desktop/DeLacey_Perlman_et_al_Asssessing-male-gelada-chest-patches_2021.RData")
...
lm_nix_adobe <- lm(adcc_rg ~ nix_rg, data=method_accuracy)
